        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new core(".swiper-main", {
                    modules: [ Navigation, Thumb, Scrollbar, EffectFade ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
...
***************************************************************************** */
        ...
        const imageSl = document.querySelector(".visible-popup");
        const galleryPopup = document.querySelector(".gallery-popup");
        if (imageSl) imageSl.addEventListener("click", (function(e) {
            if (galleryPopup) galleryPopup.classList.toggle("_active");
        }));
        const closePopup = document.querySelector(".panel-gallery-close");
        if (closePopup) closePopup.addEventListener("click", (function(e) {
            if (galleryPopup) galleryPopup.classList.remove("_active");
        }));
        window["FLS"] = true;
        isWebp();
    })();
